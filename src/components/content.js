  ...
  return (
    <div className="text-left gap-11  py-12 px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2  bg-yellow-500 rounded-3xl">
      <div className="">
        ...
        <p className="mt-4  text-base font-normal  text-black-600">
          {body}
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Error,
          beatae? Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem
          ipsum dolor sit amet consectetur adipisicing elit. Error, beatae?
